...
export const listFiles = tool(
    async ({ }) => {
        ...
        const response = await axios.get("http://019e2ad7-ab54-72bb-9a3b-d4d44780f9c2.agent.localhost/list-files")
...
export const readFiles = tool(
    async  ({ files: [] }) => {
        ...
        const response = await axios.get("http://019e2ad7-ab54-72bb-9a3b-d4d44780f9c2.agent.localhost/read-files?files=" + files.join(','))
...
export const updateFiles = tool(
    async ({ files }) => {
        ...
        const response = await axios.patch("http://019e2ad7-ab54-72bb-9a3b-d4d44780f9c2.agent.localhost/update-files", {
            updates: files
        })
