...
export default function Home() {
  ...
  // Ye line login ke waqt save kiye gaye 'username' ko auto-pick karegi
  ...
  const handleStart = () => {
    ...
    navigate("/game", {
      state: { 
        ...
        playerName: playerName // Auto-passed to game
      },
    });
  };
    ...
    <div className="min-h-screen bg-slate-950 pt-16">
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-14">
          ...
          >
            Outsmart the <span className="text-cyan-400">AI Seller.</span>
            <br />
            Win the <span className="text-amber-400">Best Deal.</span>
          </h1>
