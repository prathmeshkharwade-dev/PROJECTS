...
export default function Register() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        // ── FIX: AUTO-LOGIN REMOVED ──
        // Registration successful hone par ab seedha Login page par bhejenge
        navigate("/login"); 
      } else {
        // Backend ka error message (e.g. Email already exists)
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-slate-950 overflow-hidden text-white font-sans p-4">
      ...
      <div className="relative z-10 w-full max-w-md p-8 bg-slate-900/50 backdrop-blur-xl border border-slate-800 rounded-2xl shadow-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm">Create an account to save your high scores</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="flex flex-col gap-5">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              type="text"
              name="username"
              placeholder="Enter a cool player name"
